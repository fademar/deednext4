    ...
    case "female":
      return (
        <>
          ...
          {" | "}
          <Text type="secondary">Patronyme:</Text> {data.referentMale.patronyme}
          {" | "}
          <Text type="secondary">Last Name:</Text> {data.referentMale.lastName}
          {" | "}
    ...
    case "bobody-corporatey":
      return (
        <>
          <Text type="secondary">Sex:</Text> {data[sex]}
          <br />
          <Text type="secondary">Corporation Name:</Text> {data.corporationName}
          <br />
